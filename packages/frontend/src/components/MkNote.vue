	...
	<article v-else :class="$style.article" @contextmenu.stop="onContextmenu">
		...
		<div :class="$style.main">
			...
			<footer :class="$style.footer">
				...
				<button v-if="prefer.s.showTranslateButtonInNoteFooter && $i?.policies.canUseTranslator && instance.translatorAvailable" :class="$style.footerButton" class="_button" @mousedown.prevent="translate()">
...
const isRedacted = ref<boolean>(
	prefer.s.hideDirectMessages &&
	prefer.s.privateMode &&
