...
export async function common(createVue: () => Promise<App<Element>>) {
	...
	if (!instance.canSkipInitialTutorial && $i && !iAmAdmin && store.state.accountSetupWizard !== -1 && !location.pathname.startsWith('/onboarding') && !location.pathname.startsWith('/signup-complete')) {
