	...
	<div class="_spacer" style="--MI_SPACER-w: 700px; --MI_SPACER-min: 16px; --MI_SPACER-max: 32px;">
		<FormSuspense :p="init">
			<div class="_gaps_m">
				...
				<MkFolder>
					<template #icon><i class="ti ti-link-plus"></i></template>
					...
					<MkButton primary @click="save_urlAndSiteSettings">{{ i18n.ts.save }}</MkButton>
				</MkFolder>
			</div>
		</FormSuspense>
	</div>
...
async function onChange_prohibitSkippingInitialTutorial(value: boolean) {
	os.apiWithDialog('admin/update-meta', {
...
function save_urlAndSiteSettings() {
	os.apiWithDialog('admin/update-meta', {
