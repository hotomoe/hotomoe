...
<div class="_spacer" :style="{ '--MI_SPACER-w': narrow ? '800px' : '1100px' }">
	<div ref="rootEl" class="ftskorzw" :class="{ wide: !narrow }" style="container-type: inline-size;">
		<div class="main _gaps">
			<div v-if="user.isSuspended && iAmModerator" class="punished"><i class="ti ti-alert-triangle" style="margin-right: 8px;"></i> {{ i18n.ts.userSuspended }}</div>
			<div v-if="user.isLimited && iAmModerator" class="punished"><i class="ti ti-alert-triangle" style="margin-right: 8px;"></i> {{ i18n.ts.userLimited }}</div>
			<div v-if="user.isSilenced && iAmModerator" class="punished"><i class="ti ti-alert-triangle" style="margin-right: 8px;"></i> {{ i18n.ts.userSilenced }}</div>
					...
					<div class="banner-container" :style="style">
						...
						<div class="title">
							...
							<div class="bottom">
								...
								<span v-if="user.isAdmin" v-tooltip.noDelay="i18n.ts.administrator" style="color: var(--MI_THEME-badge);"><i class="ti ti-shield"></i></span>
...
const hideModerationNote = !iAmModerator || (prefer.s.privateMode && defaultStore.state.hideModerationLog);
const hideRoleList = prefer.s.privateMode && prefer.s.hideRoleList;
